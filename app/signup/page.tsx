            ...
            <div className="fade-in">
              {activePlan === "free" ? (
                  ...
                  <form onSubmit={handleFreeSignup} className="space-y-5">
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <button
                          type="button"
                          onClick={() => setShowFreePassword(!showFreePassword)}
                    ...
                    <div className="flex items-start">
                      <input
                        ...
                        className="mt-1 w-4 h-4 text-primary cursor-pointer border-gray-300 rounded focus:ring-primary"
                      />
                      <label
                        htmlFor="freeTerms"
                    ...
                    <button
                      ...
                      className="w-full bg-primary text-white py-4 rounded-lg cursor-pointer font-bold text-lg hover:bg-primaryHover transition shadow-lg hover:shadow-xl flex items-center justify-center"
                    >
                      <span>
                        {freeLoading
                          ? "Creating Account..."
                ...
                <div className="bg-white rounded-2xl shadow-xl p-8 border-2 border-primary">
                  <div className="mb-6">
                    <h2 className="text-2xl font-bold mb-2">Create Pro Account</h2>
                    <p className="text-gray-600">
                      Sign up and complete your Pro setup after verifying your email. ₦1,500/month.
                    </p>
                  </div>
